 ...
 * @author Mr.Mic
 */
public class viweTSStuProfile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet viweTSStuProfile</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet viweTSStuProfile at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         if (session.getAttribute("useID") == null) {
           ...
           // pr.write(userid);
            ...
            parameter = "('" + userid + "')";
            result = pc.callProc("selectTSS", parameter);
            try {
                if (result.next()) {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/viweTSSProfile.jsp");
            rd.forward(request, response);
            }
