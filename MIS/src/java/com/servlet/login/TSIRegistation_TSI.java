 ...
 * @author Mr.Mic
 */
public class TSIRegistation_TSI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TSIRegistation_TSI</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TSIRegistation_TSI at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            if (!"tsi".equals(ouid)) {
                request.setAttribute("massage", "It is not a TSI ID format");
                RequestDispatcher rd = request.getRequestDispatcher("/tsiInValid.jsp");
                rd.forward(request, response);
            }else{
