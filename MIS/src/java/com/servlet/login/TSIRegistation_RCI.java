 ...
 * @author Mr.Mic
 */
public class TSIRegistation_RCI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TSIRegistation_RCI</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TSIRegistation_RCI at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
            ...
            if (!"stu".equals(stuid)) {
                ...
                if (!"tss".equals(tssid)) {
                    ...
                    if (res.next()) {
                        ...
                        request.setAttribute("massage", "Thurunu saviya student is added to the system.");
