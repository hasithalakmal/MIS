 ...
 * @author Mr.Mic
 */
public class viweOUProfile extends HttpServlet {
   ...
   String p1, p2, p3, p4, p5, p6, p7, p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35,p36;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet viweOUProfile</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet viweOUProfile at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         if (session.getAttribute("useID") == null) {
           ...
           // pr.write(userid);
            ...
            parameter = "('" + userid + "')";
            result = pc.callProc("selectOperationalUser", parameter);
            try {
                if (result.next()) {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/viweOUProfile.jsp");
            rd.forward(request, response);
