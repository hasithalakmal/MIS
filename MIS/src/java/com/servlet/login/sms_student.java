 ...
 * @author Mr.Mic
 */
public class sms_student extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet sms_student</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet sms_student at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
