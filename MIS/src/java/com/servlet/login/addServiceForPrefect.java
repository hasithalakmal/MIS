 ...
 * @author Mr.Mic
 */
public class addServiceForPrefect extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addServiceForPrefect</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addServiceForPrefect at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            para1 = "('" + ServiseID +"','"+PrefectID+"','"+Date+ "')";
            res = pc.callProc("SelectInvolvePrefect", para1);
            ...
            if (res.next()) {
                ...
                para1 = "('" + ServiseID +"','"+PrefectID+"','"+Date+"',"+Marks+",'"+Assigned+ "')";
                pc.callProc("InsertInvolvePrefect", para1);
