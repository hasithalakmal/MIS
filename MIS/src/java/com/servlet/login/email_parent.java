 ...
 * @author Mr.Mic
 */
public class email_parent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet email_parent</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet email_parent at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
        ...
        SendMailTLS mail = new SendMailTLS();
           ...
           subject = request.getParameter("subject");
            ...
            if("All".equals(Greade)){  
                rs = pc.callProc("selectGardianEmails");
            }else{
            String para = "('" + Greade + "')";
                rs = pc.callProc("selectGardianEmail", para);
            }
            
            Message = Message + "\nThis Email is sent by Siri Vajiragnana Dahampasala.";
