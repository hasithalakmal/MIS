 ...
 * @author Mr.Mic
 */
public class email_student extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet email_student</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet email_student at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
        ...
        SendMailTLS mail = new SendMailTLS();
           ...
           subject = request.getParameter("subject");
            ...
            if("All".equals(Greade)){  
                rs = pc.callProc("selectStudentEmails");
            }else{
                 para = "('" + Greade + "')";
                rs = pc.callProc("selectStudentemail", para);
            }
