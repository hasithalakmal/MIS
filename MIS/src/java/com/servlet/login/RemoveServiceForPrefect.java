 ...
 * @author Mr.Mic
 */
public class RemoveServiceForPrefect extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RemoveServiceForPrefect</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RemoveServiceForPrefect at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            StaffID = request.getParameter("PrefectID");
            ...
            if (res.next()) {
                ...
                pc.callProc("DeleteInvolvePrefect", para1);
