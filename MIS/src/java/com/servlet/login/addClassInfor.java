 ...
 * @author Mr.Mic
 */
public class addClassInfor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addClassInfor</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addClassInfor at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Poyaday = request.getParameter("Poyaday");
            ExtraActivities = request.getParameter("ExtraActivities");
            ...
            para1 = "('" + StudentID + "','" + Grade + "')";
            res = pc.callProc("selectClassInfo", para1);
            ...
            if (res.next()) {
                ...
                para1 = "('" + StudentID + "','" + StaffID + "','" + Year +"','"+Sunday + "','" + Poyaday + "','" + ExtraActivities+"','" +Grade + "','" + Class  + "','" + p1 + "','" + p2 + "','" + p3 + "','" + p4 + "','" + p5 + "','" + p6 + "','" + p7 + "','" + p8 + "','" + p9 + "','" + p10 + "','" + p11 + "','" + p12 + "','" + p13 + "','" + p14 + "','" + p15 + "','" + p16 + "','" + p17 + "','" + p18 + "','" + p19 + "','" + p20 + "')";
                pc.callProc("insertClassInfo", para1);
