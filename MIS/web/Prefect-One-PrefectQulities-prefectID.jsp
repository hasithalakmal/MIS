<%-- 
    Document   : Prefect-One-PrefectQulities-prefectID
    Created on : Sep 29, 2014, 12:01:44 PM
    Author     : Mr.Mic
--%>
...
<%@page import="net.sf.jasperreports.engine.*"%>
        ...
        <%
          ...
          //  String Year = request.getParameter("Year");
            ...
            File reportFile = new File(application.getRealPath("/reports/Prefect-One-PrefectQulities-prefectID.jasper"));//your report_name.jasper file
