<%-- 
    Document   : studentRemoveFromCourse
    Created on : Oct 12, 2014, 6:22:53 AM
    Author     : Mr.Mic
--%>
...
<html>
    <head>
        ...
        <title>Student Remove From Course</title>
        <style>
            #container {
                width: 1320px ;
                margin-left: auto ;
        ...
        <body>
            ...
            <div id="section">
                ...
                <div id="content_container">
                    ...
                    <center>
                        <h3>Remove Student from Thurunusaviya Course</h3>
                        <form action="removeStudentforTSScourse" method="post">
                            <table>
                                <tr>
                                    <td>
                                         TSS ID
