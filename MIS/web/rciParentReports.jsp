<%-- 
    Document   : rciParentReports
    Created on : 28-Oct-2014, 16:19:42
    Author     : Prasanga
--%>
        ...
        <body>
            ...
            <div id="section">
                    ...
                    <ul id="navbar">
                        ...
                        <li><a href="#">||Reports||</a>
                            <ul>
                                ...
                                <li><a href="examReport.jsp">Exam Reports</a></li>
                                <li><a href="tssCourseDetails.jsp">TSS Reports</a></li>
                                <li><a href="prfPersonalDetails.jsp">Prefect Reports</a></li>
                ...
                <div id="content_container">
                    <form action="Student-One-Parentreport-StuIDYear.jsp" target="_blank">
                        <h3>The report created by parent based on student behavior</h3>
                        <table>
